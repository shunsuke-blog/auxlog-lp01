const features = [
  {
    icon: "🎯",
    title: "コーチ級の設計が、最初から組み込まれている",
    description:
      "ボリューム→強度→ディロード→マックスアウトの4フェーズは、パーソナルコーチが継続的な指導の中で作り上げるような設計思想を、研究ベースで体系化したもの。ゼロから自分で組む必要も、都度コーチに設計料を払う必要もない。",
  },
  {
    icon: "📈",
  ...
  {
    icon: "🧠",
    title: "コーチに頼らなくていい設計精度",
    description:
      "毎週の重量調整・フェーズの切り替えまで、本来コーチが個別に判断する部分をアプリがあらかじめ設計。人を挟まないから、低価格でもこの精度が実現できている。",
  },
  {
    icon: "🔄",
